...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      title: 'Todo List Ahmad Fauzan R',
      // Tema warna aplikasi yang lebih menarik
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF89CFF0), // Warna ungu modern
          ...
          children: [
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Apa yang ingin ojan lakukan hari ini?',
            ...
            Text(
              tasks.isEmpty
                  ...
                  : '✨ Ojan punya ${tasks.length} task${tasks.length > 1 ? 's' : ''} untuk diselesaikan',
              style: TextStyle(
                fontSize: 14,
                color: tasks.isEmpty
